...
url: https://docs-preview.tealium.com/server-side-connectors/aws-firehose-connector/
---
## Requirements
...
| Message Template Variables | Map attributes to template variable names. Template variables are available for substitution and rendering of all templates. For more information, see . |
| Message Templates | Provide one or more templates to render. Typically, a single template is used to construct a message data. For more information about syntax and extensions, see . |
...
| --- | --- |
| Message Template Variables | Map attributes to template variable names. Template variables are available for substitution and rendering of all templates. For more information, see . |
| Message Templates | Provide one or more templates to render. Typically, a single template is used to construct a message data. For more information, see . |
