...
| Unified ID (UID2 already hashed) | Unified ID (`UID2`). If already hashed, use the **Already SHA256 Hashed** option and provide a value that has been whitespace trimmed, lowercased, and hashed using SHA256. For more information, see [Use a function to generate a UID2](). |
