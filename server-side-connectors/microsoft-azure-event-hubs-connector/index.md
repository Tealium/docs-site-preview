...
url: https://docs-preview.tealium.com/server-side-connectors/microsoft-azure-event-hubs-connector/
---## Connector actions
...
| Templates | Provide one or more template to render. Typically, a single template is used to construct message data. For more information, see .|
