---
title: TikTok Audiences (Tealium-Provided Credentials) Connector Setup Guide
description: This article describes how to set up the TikTok Audiences (Tealium-Provided Credentials) connector.
url: https://docs-preview.tealium.com/server-side-connectors/tiktok-audiences-tealium-provided-credentials-connector/
---
## API information
...
Click **Establish Connection** to test the connection to TikTok.
