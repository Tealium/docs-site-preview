...
url: https://docs-preview.tealium.com/server-side-connectors/yahoo-datax-connector-deprecated/
---
This connector is now deprecated and no longer available in the connector marketplace. For the current connector, see [Yahoo DataX connector]().
