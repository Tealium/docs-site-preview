...
description: This article describes the steps required to start training your model.
url: https://docs-preview.tealium.com/server-side/predict/strategy/start-training/
---
## Save and publish to start training

Your model is currently in the _Requires Publish_ stage.
