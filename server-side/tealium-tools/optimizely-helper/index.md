...
url: https://docs-preview.tealium.com/server-side/tealium-tools/optimizely-helper/
---### Installing Tealium Tools

Make sure you have the latest version of Tealium Tools installed. This Google Chrome extension provides a variety of tools, including the Optimizely Helper. For more information, see [Tealium Tools Browser Extension]().
...
To add the code to the utag.sync.js template, click **Copy Code Snippet to Clipboard**. For more information, see [Using the utag.sync.js Script]().
