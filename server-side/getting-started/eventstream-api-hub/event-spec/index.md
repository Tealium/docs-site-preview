...
url: https://docs-preview.tealium.com/server-side/getting-started/eventstream-api-hub/event-spec/
---
...
![](https://docs-preview.tealium.com/images/server-side/eventstream-getting-started-spec.png)
