...
url: https://docs-preview.tealium.com/server-side/getting-started/eventstream-api-hub/introduction/
---
## What is Tealium EventStream?

![](https://docs-preview.tealium.com/images/tutorials/eventstream-icon.jpg)
...
![](https://docs-preview.tealium.com/images/server-side/introduction-to-eventstream-data-sources.png)
...
Learn more about [data sources](https://docs-preview.tealium.com/about-data-sources/).
...
Learn more about [event specifications](https://docs-preview.tealium.com/about-event-specifications/) and [attributes](https://docs-preview.tealium.com/about-attributes/).
...
![](https://docs-preview.tealium.com/images/server-side/white-ui-event-feed-live-events.png)
...
Learn more about [Live Events](https://docs-preview.tealium.com/about-live-events/).
...
![](https://docs-preview.tealium.com/images/server-side/white-ui-event-specification-search.png)

Learn more about [event feeds](https://docs-preview.tealium.com/about-event-feeds/).
...
![](https://docs-preview.tealium.com/images/server-side/white-ui-event-connectors-google-analytics.png)

Learn more about [event connectors](https://docs-preview.tealium.com/about-connectors/).
