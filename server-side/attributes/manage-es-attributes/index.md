...
1. In the **Add Attribute** dialog, select the attribute type and click **Continue**.
    ...
    * **Querystring Parameter**: This type automatically captures the value of the current page&#39;s URL querystring from within a browser installation.![](/images/server-side/ea-es-attribute-type.png)
