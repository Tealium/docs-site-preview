...
url: https://docs-preview.tealium.com/server-side/attributes/data-layer-enrichment/tealium-collect-dle/
---
...
To use the callback function, create a [JavaScript Code extension]() scoped to Pre Loader with the following code:
