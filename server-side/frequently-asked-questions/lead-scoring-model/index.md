...
description: This article explains tow to create a lead scoring model with Marketo, Google Analytics, and AudienceStream.
url: https://docs-preview.tealium.com/server-side/frequently-asked-questions/lead-scoring-model/
---## Introduction
