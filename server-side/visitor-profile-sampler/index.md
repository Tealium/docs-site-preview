---
title: Live Visitors (formerly Visitor profile sampler)
...
url: https://docs-preview.tealium.com/server-side/visitor-profile-sampler/
---
...
To use the sampler, navigate to **Validate &gt; Live Visitors**. 
