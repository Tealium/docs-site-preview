...
url: https://docs-preview.tealium.com/server-side/event-health/live-events/
---
## How it works
...
![](https://docs-preview.tealium.com/images/server-side/whiteui-eventstream-liveeventsandfeeds-event-specification-filters.png)
...
![](https://docs-preview.tealium.com/images/server-side/whiteui-eventstream-live-events-and-feeds-valid-events-details.png)
...
![](https://docs-preview.tealium.com/images/server-side/whiteui-eventstream-eventspecifications-invalid-event.png)
...
For more information, see [Manage event specifications](https://docs-preview.tealium.com/manage-event-specifications/#create-an event-specification).