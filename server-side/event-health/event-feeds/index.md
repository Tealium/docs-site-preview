...
url: https://docs-preview.tealium.com/server-side/event-health/event-feeds/
---
## How it works
...
1. If you want the feed to contain restricted data, select **Send Restricted Data to DataAccess**. For more information, see [About Restricted Data]()  Restricted data settings do not apply to connectors. Attributes marked as restricted data are always included, whether you are sending them through mappings or as part of the visitor profile. 
1. Click **Save**.
