...
![](https://docs-preview.tealium.com/images/server-side/whiteui-eventstream-eventspecifications-viewcode.png)
...
For more information, see [Live events](https://docs-preview.tealium.com/about-live-events/#event-specification-display-filters).