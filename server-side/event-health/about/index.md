...
url: https://docs-preview.tealium.com/server-side/event-health/about/
---
## How it works
...
![](https://docs-preview.tealium.com/images/server-side/whiteui-eventspecifications-videocomplete.png)
...
![](https://docs-preview.tealium.com/images/server-side/valid-video-complete-event.png)
...
![](https://docs-preview.tealium.com/images/server-side/invalid-video-complete-event.png)
...
![](https://docs-preview.tealium.com/images/server-side/whiteui-eventstream-liveeventfeed.png)
...
![](https://docs-preview.tealium.com/images/server-side/whiteui-eventstream-liveeventsandfeeds-add-unknown-attribute.png)
...
![](https://docs-preview.tealium.com/images/server-side/video-complete-event-feed.png)
...
![](https://docs-preview.tealium.com/images/server-side/whiteui-eventstream-liveevents-filter-drop-down-lists.png)
...
For more information, see [Use a trace ID](https://docs-preview.tealium.com/about-live-events/#use-a-trace-id).
...
![](https://docs-preview.tealium.com/images/server-side/event-health-table.png)
