...
url: https://docs-preview.tealium.com/server-side/audiencestream-dashboard/
---
The AudienceStream Dashboard shows trend data for audiences, connector actions, badge attributes, number attributes, and boolean attributes across a configurable time range. Use it to monitor how attribute and audience values change over time and compare current and previous time periods.
...
1. In the sidebar, go to **Analyze &gt; Audience Dashboard.**
