...
url: https://docs-preview.tealium.com/administration/resources/navigation-menu/
---
## Overview
...
* **Govern**  
Manage data quality, privacy, and consent, including consent orchestration and visitor search.
* **Transform**  
...
Use this table to find where a feature from the classic navigation is located in the new navigation.
...
| Old location | New location |
| ------------ | ------------ |
| Server-Side Versions | Server-Side Versions |
