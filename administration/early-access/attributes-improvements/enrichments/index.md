...
url: https://docs-preview.tealium.com/administration/early-access/attributes-improvements/enrichments/
---
...
1. The settings vary depending on the data type of enrichment. For details about enrichments for each data type, see [Data Types]().
