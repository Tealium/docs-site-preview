...
url: https://docs-preview.tealium.com/administration/account-org/permissions-system-migration-guide/migration-about/
---
## How it works
...
* [**Permission group**](): (usually referred to as **group**) defines a set of access levels to product features in specific profiles. They also determine access to publishing. Users in a group receive permissions for the associated profiles, making it easier for you to manage permissions for a large number of users.
* [**Admin role**](): grants access to specific account-level features. Use admin roles to delegate specialized or highly sensitive responsibilities to trusted members of your team. Users without admin roles receive a basic user role.
...
1. Customers enable Permissions Enforcement to change from legacy to platform permissions.
    * If your users encounter problems, disable [Permissions Enforcement]() to roll back to legacy permissions while you diagnose and fix the problems.
