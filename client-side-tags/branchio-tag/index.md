...
url: https://docs-preview.tealium.com/client-side-tags/branchio-tag/
---
...
First, go to the tag marketplace and add the Branch.io tag (learn more about [how to add a tag]()).
