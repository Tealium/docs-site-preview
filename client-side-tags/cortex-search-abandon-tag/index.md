...
url: https://docs-preview.tealium.com/client-side-tags/cortex-search-abandon-tag/
---
## Tag Configuration

First, go to the tag marketplace and add the Cortex Search Abandon Tag to your profile (See [Add a tag]()).
...
Since the Cortex Search Abandon Tag is e-commerce enabled, it will automatically use the default [E-Commerce Extension]() mappings. Manually mapping in this category is generally not needed unless:
