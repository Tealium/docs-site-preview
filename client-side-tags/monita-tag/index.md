...
url: https://docs-preview.tealium.com/client-side-tags/monita-tag/
---
...
Monita’s tag code is designed to be loaded as a library before the page loads. So, instead of using the Tealium tag marketplace to install this tag, use the [JavaScript Extension]().
