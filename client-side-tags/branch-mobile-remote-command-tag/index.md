...
url: https://docs-preview.tealium.com/client-side-tags/branch-mobile-remote-command-tag/
---
...
First, go to the tag marketplace and add the Branch Mobile Remote Command tag (Learn more about [how to add a tag]()).
