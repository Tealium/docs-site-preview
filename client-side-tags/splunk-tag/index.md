...
url: https://docs-preview.tealium.com/client-side-tags/splunk-tag/
---
## Add the Tag

Tealium iQ&#39;s Tag marketplace offers a wide variety of tags. For more information, see [Manage Tags]().
...
1. Click on **Settings** at the top-right corner of the Splunk interface. From the drop-down menu, click **Data Inputs**.![](/images/client-side-tags/splunk-instance-data-inputs.png)
1. Click on **Amazon S3**. In the next screen, click **New** to create a new configuration.![](/images/client-side-tags/splunk-instance-aws-s3.png)
