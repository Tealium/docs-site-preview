...
url: https://docs-preview.tealium.com/platforms/javascript/version-4-50/
---
...
* If you have multiple iQ profiles running on the same site, complete these steps to ensure that all instances of `utag.js` on your site start using the new cookie behavior simultaneously, preventing conflicts or compatibility issues:
    ...
    1. Set the [`split_cookie`]() override to `false` on each profile to use legacy cookie behavior and maintain compatibility with older versions of utag.js still running on your site for the duration of the transition.
...
For more information, see [Settings: `always_set_v_id`](/platforms/javascript/settings/#always_set_v_id).
