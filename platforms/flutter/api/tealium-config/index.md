...
url: https://docs-preview.tealium.com/platforms/flutter/api/tealium-config/
---
## `TealiumConfig`
...
These modules are enabled or disabled using the [`TealiumConfig`](/platforms/flutter/api/tealium-config/) `collectors` property.
...
Defines the consent policy to adhere to. If no consent policy is defined on the [`TealiumConfig`](/platforms/flutter/api/tealium-config/) object, the consent manager becomes disabled.
