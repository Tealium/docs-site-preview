...
url: https://docs-preview.tealium.com/platforms/getting-started-mobile/mobile-concepts/
---
...
Tealium Collect uses [event batching](/platforms/getting-started-mobile/event-batching/) and other power-saving techniques to provide the following benefits to mobile applications:

- Reduced app size and memory footprint
- Optimized network traffic
- Minimal battery usage

Learn more about sending data [server-side](/platforms/getting-started-mobile/server-side/).
...
- Advanced data layer customization using [iQ Tag Management extensions]().
- Support client-side and server-side using the [Tealium Collect tag]().
...
Learn more about the [client-side](/platforms/getting-started-mobile/client-side/) solution.
...
Learn more about the [data layer variables](/platforms/getting-started-mobile/data-layer/) available on mobile.
...
Learn more about the latest [Tealium for Kotlin](/platforms/android-kotlin/data-layer/) and [Tealium for Swift](/platforms/ios-swift/data-layer/) libraries.
