...
url: https://docs-preview.tealium.com/platforms/android-java/data-layer/
...
These variables are added to your Tealium iQ Tag Management account when you [activate the profile for mobile use]().

Addition variables are available in the [Lifecycle Tracking Module](/platforms/android/lifecycle-tracking-module/) for 5.0.x.
