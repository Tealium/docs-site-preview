...
url: https://docs-preview.tealium.com/iq-tag-management/tags/tag-reporting/
---
...
1. In the **Dates** fields, use the calendar drop-down top select a date range.  
    ![](/images/iq-tag-management/whiteui-tiq-tag-usage-reports-select-date-range.jpg)  
...
This view displays the total of all data points captured up until that date selected in the ending date range, as shown in the following example:  
    ...
    ![](/images/iq-tag-management/whiteui-tiq-tag-reporting-trending-and-cumulative-views.jpg)
...
![](/images/iq-tag-management/whiteui-tiq-tag-reporting-loader-tag-details.jpg)
...
![](/images/iq-tag-management/whiteui-tiq-tag-reporting-vendor-tags-report.jpg)
