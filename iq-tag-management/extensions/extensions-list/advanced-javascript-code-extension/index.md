...
url: https://docs-preview.tealium.com/iq-tag-management/extensions/extensions-list/advanced-javascript-code-extension/
---
## Prerequisites
...
This is the advanced version of the JavaScript Code extension. For basic needs, see the [JavaScript Code Extension]().
...
| Publish workflow | [Publish locations]() | [Promote drafts to be approved for publishing](#publish-workflow) |
| Remote code integration | [Tealium API v3]() |[Link to GitHub repository](#working-with-github) |
...
* **Reference the UDO**  
If you are referencing a variable from the `utag_data` object, such as `page_name` , use the `b` object like this: `b[&#39;page_name&#39;]`. For more information, see [the b object](/platforms/javascript/the-b-object/).
