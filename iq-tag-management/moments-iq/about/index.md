...
url: https://docs-preview.tealium.com/iq-tag-management/moments-iq/about/
---
## Requirements
...
| `momentsiq_suppress` |String | Whether to automatically suppress experiences for returning visitors. | `never` |
