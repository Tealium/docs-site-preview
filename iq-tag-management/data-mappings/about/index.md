...
url: https://docs-preview.tealium.com/iq-tag-management/data-mappings/about/
---
...
To reference a data layer variable such as `page_name`, use the `b` object. For example, `b[&#39;page_name&#39;]`. [Learn more about the b object](/platforms/javascript/the-b-object/).
