...
url: https://docs-preview.tealium.com/iq-tag-management/save-publish/publishing-best-practices/
---
...
* **Branching, merging, and iteration**  
  ...
  * **Save/Overwrite** replaces the current version when they save their changes.
  ...
  For more information, see [About Saving]() and .
* **Merge conflict resolution**  
  ...
  For more information, see [Resolving merge conflicts]().
...
* **Development and testing environments**
  ...
  For more information, see [Publish environments]().
* **Testing tools**  
  ...
  For more information, see [Tealium Tools]().
* **Approval structure**  
  ...
  For more information, see [Publishing Workflow]().
...
![](/images/iq-tag-management/save-publish/publishingbestpractices2.png)
...
If the development team requires multiple development environments, the account administrator can create custom environments named *DEV A*, *DEV B*, etc. For more information, see, [Custom Publish Environments]().
...
* [Tealium Tools - Web Companion](): Use this browser app to inspect and validate tags that load on your web pages. It contains multiple tools to help you diagnose problems.
* [Universal Tag Debugger](): Use this tool to validate the UDO and event tracking data. 
* [Version diff tool](): Use this tool to compare your development version to another version so you can see how your changes impact the distributed universal tag files.
* [Tealium Tools - Environment Switcher](): Use this tool to switch to the **Dev** environment to check site performance.
...
For more information, see [Troubleshooting](/iq-tag-management/troubleshooting).
...
![](/images/iq-tag-management/save-publish/publishingbestpractices1.png)
...
For more information, see:
* [Merging Versions](): How to bring changes from an old version to the currently published version.
* [Version diff tool](): Compare the versions published in your file and inspect the distribution files. This lets you determine which configurations were added, removed, or unmodified between versions.
* [Merging changes between concurrent users](): How to bring in changes from concurrent users of the same profile version.
* [Concurrent Users](): Concurrent user communication tools and several example collaboration workflow scenarios.
...
For more information about testing, see [Troubleshooting](/iq-tag-management/troubleshooting).
...
![](/images/iq-tag-management/save-publish/publishingbestpractices3.png)
...
For more information about how to set up an approval workflow, see [Publish Workflow Management]().

For more information about updating the remaining development versions with the new changes to **Prod**, see [Merging changes between concurrent users]().